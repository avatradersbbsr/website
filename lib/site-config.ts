export const siteConfig = {
  ...
  url: "https://avahealthcare.in",
  ogImage: "/images/og-default.jpg",
  keywords: [
    "AVA Traders",
    "AVA Traders Bhubaneswar",
    "AVA Traders Badagada",
    "AVA Traders Puri Bypass Road",
    "AVA Traders massage chair showroom",
    "AVA Traders fitness equipment",
    "best massage chair showroom in Bhubaneswar",
    "massage chair price in Bhubaneswar",
    "leg massager Odisha showroom",
    "AVA Healthcare Badagada",
    "AVA Traders Badagada complex",
    "iRest massage chair showroom Odisha",
  ],
  contact: {
